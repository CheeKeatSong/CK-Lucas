...
public class RecyclerViewStudentPickList extends AdminToolbarDrawer {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
            ...
            if (actionBar != null) {
                actionBar.setTitle("RecyclerViewStudentPickList");
            }
        }
        ...
        tabIdentifier = 11;
        mAdapter = new RecyclerStudentPickListAdapter(this);
