...
public class RecyclerViewSurvey extends AdminToolbarDrawer {
    ...
    private static final String TAG = "RecyclerViewSurvey";
    ...
    /**
     * Substitute for our onScrollListener for RecyclerViewSurvey
     */
