...
public class RecyclerViewStudent extends AdminToolbarDrawer {
    ...
    private static final String TAG = "RecyclerViewStudent";

    public void sorting(int option){
        this.option = option;
        mAdapter = new RecyclerStudentTabAdapter(getApplicationContext());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabIdentifier = 3;
        mAdapter = new RecyclerStudentTabAdapter(this);
        ((RecyclerStudentTabAdapter) mAdapter).setMode(Attributes.Mode.Single);
    ...
    /**
     * Substitute for our onScrollListener for RecyclerViewStudent
     */
