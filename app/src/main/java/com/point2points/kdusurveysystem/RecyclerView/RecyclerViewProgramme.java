...
public class RecyclerViewProgramme extends AdminToolbarDrawer {
    ...
    private static final String TAG = "RecyclerViewProgramme";

    public void sorting(int option){
        this.option = option;
        mAdapter = new RecyclerProgrammeTabAdapter(getApplicationContext());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabIdentifier = 6;
        mAdapter = new RecyclerProgrammeTabAdapter(this);
        ((RecyclerProgrammeTabAdapter) mAdapter).setMode(Attributes.Mode.Single);
    ...
    /**
     * Substitute for our onScrollListener for RecyclerViewProgramme
     */
